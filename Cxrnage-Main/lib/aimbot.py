...
aim_height = 2.5 # The lower the number, the higher the aim_height. For example: 2 would be the head and 100 would be the feet.
...
class Aimbot:
    ...
    def __init__(self, box_constant = 350, collect_data = False, mouse_delay = 0.0009, debug = False):
        ...
        if torch.cuda.is_available():
            ...
            print(colored("[!] Check your PyTorch installation, or else performance will be crap ", "red"))
